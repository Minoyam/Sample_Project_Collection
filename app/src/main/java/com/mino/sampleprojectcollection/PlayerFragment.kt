...
import com.mino.sampleprojectcollection.databinding.FragmentPlayerBinding
import com.mino.sampleprojectcollection.service.MusicDto
import com.mino.sampleprojectcollection.service.MusicService
...
class PlayerFragment : Fragment(R.layout.fragment_player) {
    ...
    private lateinit var playerAdapter: PlayListAdapter
        ...
        binding?.let { binding ->
            ...
            player?.addListener(object : Player.Listener {
                ...
                override fun onMediaItemTransition(mediaItem: MediaItem?, reason: Int) {
                    ...
                    playerAdapter.submitList(model.getAdapterModels())
                }
            })
        }
    }
    ...
    private fun playMusic(musicModel: MusicModel) {
        ...
        player?.seekTo(model.currentPosition, 0L)
        player?.play()
    }
