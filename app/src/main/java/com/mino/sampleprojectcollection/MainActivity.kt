...
class MainActivity : AppCompatActivity() {
        ...
        runButton.setOnClickListener {
            ...
            list.forEachIndexed { index, number ->
                numberTextViewList[index].apply {
                    ...
                    background = setNumberBackground(number)
                }
            }
        }
    ...
    private fun initAddButton() {
        addButton.setOnClickListener {
            ...
            numberTextViewList[pickNumberSet.size].apply {
                ...
                background = setNumberBackground(numberPicker.value)
            }
    ...
    private fun setNumberBackground(number: Int) =
        when (number) {
            in 1..10 -> {
                ContextCompat.getDrawable(this@MainActivity, R.drawable.circle_yello)
            }
            in 11..20 -> {
